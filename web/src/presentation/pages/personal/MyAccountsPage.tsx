...
const NewPersonalAccountForm = ({ onDone }: { readonly onDone: () => void }) => {
...
export const MyAccountsPage = () => {
  ...
  const accounts = useAtomValue(listAccountsAtom("personal"))
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        {!adding ? (
          <Button type="button" accent="pessoal" onClick={() => setAdding(true)}>
            {t("myAccounts.addAccount")}
          </Button>
        ) : null}
      </div>

      {adding ? <NewPersonalAccountForm onDone={() => setAdding(false)} /> : null}
